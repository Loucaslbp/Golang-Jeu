...
type Configuration struct {
	...
	GameType 					  string // "join" | "load" | "new"
	ServerAddr 					  string // for GameType = "join"
	GameDir						  string // for GameType = "load" | "new"
	Seed						  int64 // for GameType = "load" | "new"
...
func SetComputedFields() {
	...
	// for smooth follow char
	Global.ScreenCenterTileX = (Global.NumTileX + 2) / 2 
	Global.ScreenCenterTileY = (Global.NumTileY + 2) / 2
}
